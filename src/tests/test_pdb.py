...
from caddkit.api.pdb import (
    create_query_by_uniprot_id,
    create_query_by_deposition_date,
    create_query_by_experimental_method,
    create_query_by_resolution,
    create_query_by_polymer_count,
    create_query_by_ligand_weight,
    search_rcsb_pdb,
)

def test_query_by_uniprot_id():
    query = create_query_by_uniprot_id("P00533")
...
def test_query_by_deposition_date():
    query = create_query_by_deposition_date("2020-01-01")
